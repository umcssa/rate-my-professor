...
class TestPostPublic(unittest.TestCase):
    """Unit tests /p/<postid_url_slug>/ URLs."""
    ...
    def test_postid_1(self):
        ...
        response = self.app.get("/p/1/")
        self.assertEqual(response.status_code, 200,
                      "GET /p/1/ did not return 200.")    
